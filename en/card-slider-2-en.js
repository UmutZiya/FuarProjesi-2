...
document.addEventListener('DOMContentLoaded', function() {
  const cardsData = {
    gundem: [
      ...
      { image: "./images/card-2-slider-6.png", date: "2024-05-02", tag: "Agenda", title: "Countdown Has Started for the 17th SolarEX Istanbul, Which Will Bring Together Solar Industry Brands with World Leaders!", link: "blog-single-page.html" },
      { image: "./images/card-2-slider-7.png", date: "2024-05-02", tag: "Agenda", title: "Countdown Has Started for the 17th SolarEX Istanbul, Which Will Bring Together Solar Industry Brands with World Leaders!", link: "blog-single-page.html" },
    ],
    blog: [
      { image: "./images/card-2-slider-8.png", date: "2024-03-07", tag: "Blog", title: "The heart of the textile industry beat at the Bursa Textile Show Fair.", link: "blog-single-page.html" },
    ],
    duyurular: [
      { image: "./images/card-2-slider-10.jpg", date: "2024-05-04", tag: "Announcement", title: "Countdown Has Started for the 17th SolarEX Istanbul, Which Will Bring Together Solar Industry Brands with World Leaders!", link: "blog-single-page.html" },
      { image: "./images/card-2-slider-2.png", date: "2024-05-04", tag: "Announcement", title: "Countdown Has Started for the 17th SolarEX Istanbul, Which Will Bring Together Solar Industry Brands with World Leaders!", link: "blog-single-page.html" },
    ],
    haberler: [
      { image: "./images/card-2-slider-4.png", date: "2024-05-05", tag: "News", title: "Countdown Has Started for the 17th SolarEX Istanbul, Which Will Bring Together Solar Industry Brands with World Leaders!", link: "blog-single-page.html" },
    ]
  };
